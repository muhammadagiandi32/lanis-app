            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="../../demo13/dist/index.html">
                        <img alt="Logo" src="{{ asset('assets/dist/assets/media/logos/klc.jpeg')}}"
                            class="h-30px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link  {{request()->is('list-bayar') ? 'active' : ''}}"
                                    href="{{ url('list-bayar') }}">
                                    <span class="menu-icon">
                                        <i class="bi bi-calendar3-event fs-3"></i>
                                    </span>
                                ...
                                <a class="menu-link  {{request()->is('list-siswa') ? 'active' : ''}}"
                                    href="{{ url('list-siswa') }}">
                                    <span class="menu-icon">
                                        <i class="bi bi-calendar3-event fs-3"></i>
                                    </span>
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="../../demo13/dist/apps/projects/project.html" class="w-30px me-3"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-5">
                                        <a href="#"
                                            class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">Auth::user()->name</a>
