...
<body id="kt_body"
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="../../demo13/dist/index.html">
                        <img alt="Logo" src="{{ asset('assets/dist/assets/media/logos/logo-demo13.svg')}}"
                            class="h-15px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="toolbar" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <!--begin::Title-->
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Delivery</h1>
                                <!--end::Title-->
                            </div>
                            <!--end::Page title-->
    ...
    <div class="engage-toolbar d-flex position-fixed px-5 fw-bolder zindex-2 top-50 end-0 transform-90 mt-20 gap-2">
        ...
        <button id="kt_engage_demos_toggle"
            ...
            title="Check out 21 more demos" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-dismiss="click"
