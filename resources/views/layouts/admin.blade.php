...
<head>
    ...
    <link href="{{ asset('assets/dist/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css')}}" rel="stylesheet" type="text/css" />
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="/metronic8/demo1/../demo1/index.html">
                        <img alt="Logo" src="{{ asset('assets/dist/assets/media/logos/klc.jpeg')}}" class="h-35px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link  {{request()->is('siswas') ? 'active' : ''}}" href="{{ url('siswas') }}">
                                    <span class="menu-icon">
                                        <i class="bi bi-calendar3-event fs-3"></i>
                                    </span>
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link  {{request()->is('list-siswa') ? 'active' : ''}}" href="{{url('tagihan')}}">
                                    <span class="menu-icon">
                                        <i class="bi bi-calendar3-event fs-3"></i>
                                    </span>
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                        <!--begin::Title-->
                                        <a href="../../demo13/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Meeting
                                            with customer</a>
                                        <!--end::Title-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
                                        <!--begin::Title-->
                                        <a href="../../demo13/dist/apps/projects/project.html" class="fs-5 text-dark text-hover-primary fw-bold w-375px min-w-200px">Project
                                    ...
                                    <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                                <a href="../../demo13/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bolder">Finance KPI App
                                                    Guidelines</a>
                                                <!--end::Desc-->
                                                <!--begin::Number-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="../../demo13/dist/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo13/dist/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                ...
                <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_help_body" data-kt-scroll-dependencies="#kt_help_header" data-kt-scroll-offset="5px">
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="../../demo13/dist/documentation/getting-started.html" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Documentation &amp;
                                    Videos</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="../../demo13/dist/documentation/base/utilities.html" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Plugins &amp;
                                    Components</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex align-items-center mb-7">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                            ...
                            <div class="d-flex flex-column me-2 me-lg-5">
                                <!--begin::Title-->
                                <a href="https://devs.keenthemes.com/metronic" class="text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1">Metronic
                                    Downloads</a>
                                <!--end::Title-->
                                <!--begin::Description-->
                            ...
                            <div class="card mt-5">
                                ...
                                <!--begin::Form-->
                                    <div class="card-body py-3">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleSelectl">Pilih Bulan</label>
                                            <select name="bulan" class="form-control form-control-lg" id="exampleSelectl">
                                                <option value="{{ date('Y').'-01-10' }}">{{ date('Y').'-01-10' }}</option>
                                                <option value="{{ date('Y').'-02-10' }}">{{ date('Y').'-02-10' }}</option>
                                                <option value="{{ date('Y').'-03-10' }}">{{ date('Y').'-03-10' }}</option>
                                                <option value="{{ date('Y').'-04-10' }}">{{ date('Y').'-04-10' }}</option>
                                                <option value="{{ date('Y').'-05-10' }}">{{ date('Y').'-05-10' }}</option>
                                                <option value="{{ date('Y').'-06-10' }}">{{ date('Y').'-06-10' }}</option>
                                                <option value="{{ date('Y').'-07-10' }}">{{ date('Y').'-07-10' }}</option>
                                                <option value="{{ date('Y').'-08-10' }}">{{ date('Y').'-08-10' }}</option>
                                                <option value="{{ date('Y').'-09-10' }}">{{ date('Y').'-09-10' }}</option>
                                                <option value="{{ date('Y').'-10-10' }}">{{ date('Y').'-10-10' }}</option>
                                                <option value="{{ date('Y').'-11-10' }}">{{ date('Y').'-11-10' }}</option>
                                                <option value="{{ date('Y').'-12-10' }}">{{ date('Y').'-12-10' }}</option>
                                            </select>
                                        </div>
                                    </div>
